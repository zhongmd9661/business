...
class ExtractedFields:
    ...
    transaction_no: Optional[str] = None  # 交易单号（支付流水）
    merchant_order_no: Optional[str] = None  # 商户单号
    ...
    raw_text: str = ""
    source_file: Optional[str] = None  # 数据来源文件
...
class BatchReviewReport:
    ...
    comparison_rows: Optional[list[dict[str, str]]] = None
    """对比表数据: 每行一个文档 {doc_type: str, filename: str, field1: str, ...}"""
